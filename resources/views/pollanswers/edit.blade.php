                        ...
                        <div class="post-wrapper">
                            <div class="post-body"><div class="post-content">
                                ...
                                <div class="row top-padding bottom-padding single-h-padding limit-width row-parent" data-imgready="true">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            {!! Form::model($pollanswer, ['route' => ['pollanswers.update', $pollanswer->id], 'method' => 'patch']) !!}

                                            <div class="form-group col-sm-6">
                                                <input type="hidden" id="pollquestion_id" name="pollquestion_id" value="{{ $pollanswer->pollquestion_id }}">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                {!! Form::text('answer', $pollanswer->answer, ['class' => 'form-control']) !!}
                                            </div>

                                            <!-- Submit Field -->
                                            <div class="form-group col-sm-12">
                                                {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
                                                <a href="/mychoice/{{ $pollanswer->pollquestion_id }}" class="btn btn-default">Cancel</a>
                                            </div>
