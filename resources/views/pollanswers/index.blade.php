                        ...
                        <div class="post-wrapper">
                            <div class="post-body"><div class="post-content">
                                    ...
                                    <div class="btnwr1" data-imgready="true" style="width:100%; margin:25px auto 20px; text-align:center">
                                        ...
                                        <a href="/addanswer/{{ $pollanswers[0]['pollquestion_id'] }}" class="custom-link btn btn-text-skin btn-accent btn-hover-nobg btn-icon-left" style="width:280px;margin-right:20px;padding:30px">Add New</span></a>
