                        ...
                        <div class="post-wrapper">
                            <div class="post-body"><div class="post-content">
                                    ...
                                    <div class="row top-padding bottom-padding single-h-padding limit-width row-parent" data-imgready="true" style="padding-top:20px;">
                                        ...
                                        <h1 class="pull-left">Question</h1>
                                ...
                                <div class="row top-padding bottom-padding single-h-padding limit-width row-parent" data-imgready="true">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            {!! Form::model($pollquestion, ['route' => ['pollquestions.update', $pollquestion->id], 'method' => 'patch']) !!}

                                            <!-- Questionnaire Id Field -->
                                                <div class="form-group col-sm-6">
                                                    <input type="hidden" id="questionnaire_id" name="questionnaire_id" value="{{ $pollquestion->questionnaire_id }}">
                                                </div>
                                                ...
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <a href="/seeallmyquestions/{!! $pollquestion->questionnaire_id !!}" class="btn btn-default">Cancel</a>
                                                </div>
