                        ...
                        <div class="post-wrapper">
                            ...
                            <div class="post-body"><div class="post-content" style="padding:30px;">
                                    ...
                                    <div data-imgready="true" >
                                        ...
                                        <form action="{{ route('testmail') }}" method="post" class="wpcf7-form" novalidate="novalidate">
                                            {{ csrf_field() }}
                                        <table class="table table-hover">
                                            ...
                                            <tr style="background:#f5f5f5; padding:20px; line-height:50px; text-transform:uppercase">
                                                <th>SN
                                                    <a class="checkall" href="#">Check All</a>
                                                    <a class="uncheckall" href="#">Uncheck All</a></th>
                                                <th>Title</th>
                                                <th>contact</th>
                                                <th>Action</th>
                                            ...
                                            @foreach($teams as $item)
                                                ...
                                                $id= $item->id; ?>
                                                <tr>
                                                    <td><?php echo $counter;?> <input class="checkbox" type="checkbox" name="check[]" value="{{$item->id}}"></td>
                                                    <td>{{$item->title}}</td>
                                                ...
                                                <input  type="hidden" name="dbid" value="{{$user->id}}">
                                            @endforeach
                                            </tbody>
                                        </table>

                                            <input type="submit" Value="Send" class="custom-link btn btn-text-skin btn-accent btn-hover-nobg btn-icon-left" style="width:280px;margin-right:20px;padding:30px" >                                        </form>
