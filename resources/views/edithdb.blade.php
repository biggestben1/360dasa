                    ...
                    <div class="row top-padding bottom-padding single-h-padding limit-width row-parent" data-imgready="true" style="padding-top:20px;">
                      ...
                      <div class="card">
                        <div class="card-content">
                                                    ...
                                                    <h1>Edit contact to database </h1>
                                                    ...
                                                    <form action="{{ route('updatecontact') }}" method="post">
                                                      ...
                                                      <div class="form-group" style="padding-bottom:20px"><label class="control-label">Title:</label>
                                                        <input type="text" name="title" required class="form-control" placeholder="Enter Title" value="{{$user->title}}">
                                                      </div>
                                                      <div class="form-group" style="padding-bottom:20px"><label class="control-label">First Name:</label>
                                                        <input type="text" name="first_name" required class="form-control" placeholder="Enter first name" value="{{$user->firstname}}">
                                                      </div>
                                                      ...
                                                      <div class="form-group" style="padding-bottom:20px"><label class="control-label">Phone Number:</label>
                                                        <input type="text" name="phone_number" required class="form-control" placeholder="Enter Phone Number" value="{{$user->phonenumber}}">
                                                      </div>
                                                      <div class="form-group" style="padding-bottom:20px"><label class="control-label">Email Address:</label>
                                                        <input type="email" name="email" required class="form-control" placeholder="Enter Email" value="{{$user->email}}">
                                                      </div>
                                                      <div class="form-group" style="padding-bottom:20px"><label class="control-label">Address:</label>
                                                        <input name="address" class="form-control" placeholder="Enter Address" value="{{$user->address}}">
                                                      </div>

                                                      <div class="form-group" style="padding-bottom:20px"><label class="control-label">Country:</label>
                                                        <input type="text" name="country" required class="form-control" placeholder="Enter Country" value="{{$user->country}}">
                                                      </div>
