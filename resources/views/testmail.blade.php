                      ...
                      <div class="card">
                        <div class="card-content">
                                                    ...
                                                    <form action="{{ route('testemail') }}" method="post">
                                                      ...
                                                      <button type="submit" name="submitted" class="custom-link btn btn-text-skin btn-accent btn-hover-nobg btn-icon-left" style="width:280px;margin-right:20px;padding:30px!important">Send mail</button>
