        ...
        <div class="post-wrapper">
            <div class="post-body"><div class="post-content">
                    ...
                    <div class="row top-padding bottom-padding single-h-padding limit-width row-parent" data-imgready="true" style="padding-top:20px;">
                        ...
                        <div class="top-padding bottom-padding col-lg-6 btn-" style="background:#f5f5f5; text-align:center; border:3px solid #fff;">
                            <a href=""><span style="font-size:14px; color:#666"> No of Survey Created</span></a></br>
                            <a href=""> <span style="font-size:40px; color:#666">{{ \App\Objective::where(['user_id' => $id])->get()->count() }}</span></a>
                        </div>



                        <div class="top-padding bottom-padding col-lg-6 bg-danger" style="background:#f5f5f5; text-align:center;border:3px solid #fff;">
                            <a href=""><span style="font-size:14px; color:#666"> Database</span></a></br>
                            <a href=""><span style="font-size:40px; color:#666">{{ \App\Contactedb::where(['user_id' => $id])->get()->count() }}</span></a>
                        </div>
                      ...
                      <div data-imgready="true" style="width:600px; margin:25px auto 20px; text-align:center">

                          <a href="/survey/new" class="custom-link btn btn-text-skin btn-accent btn-hover-nobg btn-icon-left" style="width:250px;margin-right:20px;padding:30px">Create Survey</span></a>
                          <a href="{{ route('viewdb') }}" class="custom-link btn btn-text-skin btn-color-210407 btn-hover-nobg btn-icon-left" style="width:250px; padding:30px">Add Database</span></a>
