        ...
        <div class="post-wrapper">
            ...
            <div class="post-body"><div class="post-content" style="padding:30px;">
                    ...
                    @if ($errors->any())
                        ...
                        <form action="/importExcel/{{Request::segment(2)}}" method="post"  enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="file" name="import_file" />
                            <input type="hidden" name="dbid" id="dbid" value="{{Request::segment(2)}}"   />
                            <button type="submit" name="submitted" class="btn btn-sm btn-info m">Submit Contact</button>
