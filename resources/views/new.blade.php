...
@section('content')
<script src="http://360dasa.org/public/ckeditor/ckeditor.js"></script>
<style>
...
<article id="post-54944" class="page-body style-color-xsdn-bg post-54944 page type-page status-publish has-post-thumbnail hentry page_category-classic page_category-top-menu">
  ...
  <div class="card" style="box-shadow: 0 1px 7px 0 rgba(50,50,50,.2);padding:20px; margin:20px 0 50px 0;">
      <div class="card-content">
        <h1 style="padding:20px; ">Create New Survey  </h1>
      ...
      <form method="POST" action="create" id="boolean">
        ...
        <div class="row">
          ...
          <div class="input-field col s12">
          <button  class="custom-link btn btn-text-skin btn-accent btn-hover-nobg btn-icon-left" style="width:250px;margin-right:20px;padding:30px">Create</button>
          </div>
        </div>
        </form>
    </div>
