        ...
        <div class="post-wrapper">
            ...
            <div class="post-body"><div class="post-content" style="padding:30px;">
                    ...
                    <div style="float:left">
                      <a href="/adddata/{{Request::segment(2)}}" class="custom-link btn btn-text-skin btn-accent btn-hover-nobg btn-icon-left" style="margin-right:20px;padding:30px; margin-bottom:5px;">Add New</a>
                    </div>

                    <div style="float:right">
                        <a href="/public/360survay.xlsx" class="btn btn-accent btn-outline" style="padding:5px 10px!important">Download Format</a>
                        <a href="/uploudexce/{{Request::segment(2)}}" class="btn btn-accent btn-outline" style="padding:5px 10px!important">Upload Database</a>
                        <a href="/downloadExcel/{{Request::segment(2)}}" class="btn btn-accent btn-outline" style="padding:5px 10px!important">Download Database</a>
                      </div>
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($teams as $item)
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->address}}</td>
                                    <td>{{$item->country}}</td>
                                    <td><a href="/edithdb/{{$item->id}}" class="btn btn-accent btn-outline" style="padding:5px 10px!important">Edit</a> <a href="/deletecontact/{{$item->id}}" class="btn btn-accent btn-outline" style="padding:5px 10px!important">Delete</a> </td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
